define(["exports"], (function(t) {
    ...
    class R {
      constructor(t, e) {
        this.h = {}, Object.assign(this, e), this.event = e.event, this.u = t, this.l = new p, this.p = [], this.R = [...t.plugins], this.m = new Map;
      ...
      async getCacheKey(t, e) {
        ...
        if (!this.h[s]) {
          let n = t;
          for (const t of this.iterateCallbacks("cacheKeyWillBeUsed")) n = g(await t({
            mode: e,
            request: n,
            event: this.event,
            params: this.params
    ...
    class x extends m {
      constructor(t = {}) {
        t.cacheName = f(t.cacheName), super(t), this.C = !1 !== t.fallbackToNetwork, this.plugins.push(x.copyRedirectedCacheableResponsesPlugin)
      }
      async L(t, e) {
    ...
    class O {
      constructor({
        ...
        this.K = new Map, this.P = new Map, this.T = new Map, this.u = new x({
          cacheName: f(t),
          plugins: [...e, new L({
      ...
      addToCacheList(t) {
        ...
        for (const n of t) {
          ...
          const {
            cacheKey: t,
            url: r
          } = q(n), i = "string" != typeof n && n.revision ? "reload" : "default";
          if (this.K.has(r) && this.K.get(r) !== t) throw new s("add-to-cache-list-conflicting-entries", {
